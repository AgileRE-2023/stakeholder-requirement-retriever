...
class Prodi(models.Model):
    ...
    subject = models.CharField(max_length=1, null=False, default=0) #0 for Arts & Humanities; 1 for Engineering and Technology; 2 for Life Sciences and Medicine; 3 for Natural Sciences
